...
class Si_indiamart_leads extends AdminController
{
	public function __construct()
	{
		parent::__construct();
		if (!is_admin() /*&& !has_permission('si_indiamart_leads', '', 'view')*/ && !has_permission('settings', '', 'view')) {
			access_denied(_l('si_indiamart_leads'));
		}
	}
	...
	function validate()
	{
		...
		try{
			...
			curl_setopt_array($curl, [
				...
				CURLOPT_TIMEOUT        => 30,
				CURLOPT_URL            => SI_INDIAMART_VALIDATION_URL,
				CURLOPT_POST           => 1,
				CURLOPT_POSTFIELDS     => [
					'url' => site_url(),
					'module'     => SI_INDIAMART_KEY,
