    ...
    <div class="row my-md-5 pt-md-3 my-4 pt-2 pb-lg-4 justify-content-center border-bottom">
        <div class="col-12 text-center">
            <div class="section-title">
                <h4 class="title mb-4">
                    <?= $company_name ?> Affiliate Program
                </h4>
                <p class="text-muted para-desc mx-auto">
                    If you would like to promote our products and earn commission, please register as an affiliate
                    partner by clicking the button below. If you are already an affiliate partner, please login to
    ...
    <div class="row my-md-5 pt-md-3 my-4 pt-2 pb-lg-4 justify-content-center ">
        <div class="col-12 text-center">
            <div class="section-title">
                ...
                <p class="text-muted para-desc mx-auto">
                    Make money by sharing your love for <?= $company_name ?> with your friends, family, and
                    followers! and earn <span
                            class="text-success fs-14"><?= $affiliate_commission_amount ?> <?= $affiliate_commission_type ?> </span>
                    of <?= $affiliate_rule ?>
                </p>
                <a href="<?= base_url('affiliate/become') ?>" class="btn btn-primary mt-4">
                    Become an Affiliate
            ...
            <div class="card-body">
                <div class="content pt-2">
                    <p class="text-muted para-desc mb-4 ">
                        Here are the rules of our Affiliate Program:
                    </p>
