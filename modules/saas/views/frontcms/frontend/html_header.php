...
<head>
    ...
    <meta name="description" content="Perfex">
            ...
            if (empty($affiliate) || !is_affiliate()) {
                ...
                <ul class="buy-button list-inline mb-0">
                    <li class="list-inline-item mb-0">
                        <a href="<?= base_url() . 'admin' ?>" class="btn btn-pills btn-primary">Sign in <i
                        ...
                        foreach ($main_menus as $menu_key => $menu_value) {
                            ...
                            <li class="<?php echo $menu_selected . " " . $cls_menu_dropdown; ?> ">
                                ...
                                if (!$submenus) {
                                    ...
                                    $url = '#';
                                    ?>
                                    <a href="#"><?php echo $menu_value['menu']; ?></a><span class="menu-arrow"></span>
                                    <ul class="submenu ">
                                        <?php
