                                            ...
                                            <div class="card-body">
                                                ...
                                                if (!empty($package->monthly_offer)) {
                                                    ...
                                                    <div class="d-flex monthly_price">
                                                        ...
                                                        <span class="price h1 mb-0"><?= $package->monthly_offer ?></span>
                                                        <span class="h4 align-self-end mb-1">/mo</span>
                                                    </div>
                                                    <del class="d-flex monthly_price  mb-4">
                                                        <span class=" mb-0">$</span>
                                                        <span class="price mb-0"><?= $package->monthly_price ?></span>
                                                    ...
                                                    <div class="d-flex mb-4 monthly_price">
                                                        <span class="h4 mb-0 mt-2">$</span>
                                                        <span class="price h1 mb-0"><?= $package->monthly_price ?></span>
                                                        <span class="h4 align-self-end mb-1">/mo</span>
                                                    </div>
                                                    <?php
                                                }
                                                ...
                                                if (!empty($package->yearly_offer)) {
                                                    ...
                                                    <del class="d-flex yearly_price d-none">
                                                        <span class=" mb-0">$</span>
                                                        <span class="price mb-0"><?= $package->yearly_price ?></span>
                                                        <span class="align-self-end mb-1">/yr</span>
                                                    </del>
                                                    <div class="d-flex mb-4 yearly_price d-none">
                                                        <span class="h4 mb-0 mt-2">$</span>
                                                        <span class="price h1 mb-0"><?= $package->yearly_offer ?></span>
                                                    ...
                                                    <div class="d-flex mb-4 yearly_price d-none">
                                                        <span class="h4 mb-0 mt-2">$</span>
                                                        <span class="price h1 mb-0"><?= $package->yearly_price ?></span>
                                                        <span class="h4 align-self-end mb-1">/yr</span>
                                                    </div>
                                                    <?php
                                                }
                                                ...
                                                <div class="d-flex mb-4 lifetime_price d-none">
                                                    <span class="h4 mb-0 mt-2">$</span>
                                                    <span class="price h1 mb-0"><?= $package->lifetime_price ?></span>
