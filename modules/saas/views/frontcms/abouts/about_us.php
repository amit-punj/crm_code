                ...
                <div class="ms-lg-4">
                    <div class="d-flex mb-4">
                        <span class="text-primary h1 mb-0"><span class="counter-value display-1 fw-bold"
                                                                 data-target="<?= (!empty($abouts_info->number)) ? $abouts_info->number : '' ?>">0</span>+</span>
                        <span class="h6 align-self-end ms-2">Years <br/>
                            Experience</span>
                    </div>
                    ...
                    <div class="position-relative">
                        ...
                        <div class="play-icon">
                            <a href="<?= (!empty($about_footer->links)) ? $about_footer->links : '#' ?>"
                               data-type="youtube" data-id="yba7hPeTSjk" class="play-btn lightbox">
