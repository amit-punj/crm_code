                                    ...
                                    foreach ($all_packages as $v_package) {
                                        ...
                                        if (isset($company_info)) {
                                            if ($company_info->package_id == $v_package->id) {
                                             ...
                                             data-subtext="<?php echo _l('monthly') . ': ' . $v_package->monthly_price . ' ' . _l('lifetime') . ': ' . $v_package->lifetime_price . ' ' . _l('yearly') . ': ' . $v_package->yearly_price . ' ' . strip_tags(mb_substr(!empty($c_pricing->description) ? $c_pricing->description : '', 0, 200)) . '...'; ?>"><?php echo $v_package->name; ?></option>
                                    <?php } ?>
                                    <?php
                                }
                                ?>
