...
<div class="_buttons tw-mb-2 sm:tw-mb-4">
    <a href="<?= admin_url('custom_domain/new') ?>" class="btn btn-primary pull-left display-block">
...
<div class="panel_s <?= (!empty($action) ? '' : 'hide') ?>">
    ...
    <div class="panel-body">
        ...
        <div class="col-md-6">
            <?php echo form_open(admin_url('custom_domain/update/' . $id), ['id' => 'custom_domain_form']); ?>
            <div class="form-group">
                <label for="custom_domain">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if ($domain->status == 'pending') { ?>
                                    <a href="<?php echo admin_url('custom_domain/edit/' . $domain->request_id); ?>"
                                ...
                                <a href="<?php echo admin_url('custom_domain/delete/' . $domain->request_id); ?>"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo get_option('custom_domain_title'); ?></h4>
            </div>
