                        ...
                        <div class="form-group">
                            ...
                            <div class="row tw-mb-1 ">
                                ...
                                <div class="col-sm-4">
                                    <input required data-parsley-type="number" type="text"
                                           name="lifetime_price"
                                           placeholder="<?= _l('lifetime') ?>"
                                           class="form-control"
                                           value="<?php
                                           if (!empty($package_info->lifetime_price)) {
                                               echo $package_info->lifetime_price;
                                           }
                                           ?>"/>
                                </div>
                            </div>
                        ...
                        <div class="form-group mbot15<?= count($modules) > 0 ? ' select-placeholder' : ''; ?>">
                            <label for="allowed_modules"
                                ...
                                <i class="fa fa-question-circle" data-toggle="tooltip"
                                   title="<?php echo _l('allowed_modules_tooltip'); ?>"></i>
                            </label>
                            <br/>
