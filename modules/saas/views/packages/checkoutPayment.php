                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select name="companies_id" class="selectpicker m0"
                                    ...
                                    <option value=""></option>
                                    <?php
                                    $all_subscriber = get_old_order_by('tbl_saas_companies', null, 'id');
                                    ...
                                    foreach ($all_packages as $v_package) {
                                        ...
                                        if (isset($package_info)) {
                                            if ($package_info->id == $v_package->id) {
                                             ...
                                             data-subtext="<?php echo lang('monthly') . ': ' . $v_package->monthly_price . ' ' . _l('quarterly') . ': ' . $v_package->lifetime_price . ' ' . _l('yearly') . ': ' . $v_package->yearly_price . ' ' . strip_tags(mb_substr(!empty($c_pricing->description) ? $c_pricing->description : '', 0, 200)) . '...'; ?>"><?php echo $v_package->name; ?></option>
                                    <?php } ?>
                                    <?php
                                }
                                ?>
