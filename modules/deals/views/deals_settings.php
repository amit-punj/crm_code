                        ...
                        <div class="panel panel-custom">
                            <div class="panel-body">
                                ...
                                <div class="col-sm-6 tw-mb-4">
                                    <label for="select_company_multiple_or_single"
                                           class="control-label"><?php echo _l('select_company_multiple_or_single'); ?></label>
                                    <div class="">
                                        <div class="radio radio-inline radio-primary">
                                            <input type="radio" id="k_desc" name="select_company_multiple_or_single"
                                                   value="multiple" <?php if (get_option('select_company_multiple_or_single') == 'multiple') {
                                                echo 'checked';
                                            } ?>>
                                            <label for="k_desc"><?php echo _l('multiple'); ?></label>
                                        </div>
                                        <div class="radio radio-inline radio-primary">
                                            <input type="radio" id="k_asc" name="select_company_multiple_or_single"
                                                   value="single" <?php if (get_option('select_company_multiple_or_single') == 'single') {
                                                echo 'checked';
                                            } ?>>
                                            <label for="k_asc"><?php echo _l('single'); ?></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 tw-mb-4">
