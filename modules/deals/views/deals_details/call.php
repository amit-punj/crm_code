                ...
                <table class="table table-striped " cellspacing="0" width="100%">
                    ...
                    if (!empty($all_calls_info)) :
                        foreach ($all_calls_info as $v_calls) :
                            $client_info = $this->deals_model->check_deals_by(array('userid' => $v_calls->client_id), 'tblclients');
                    ...
                    <div class="col-md-6 mtop15">
                        ...
                        <div class="">
                            <select name="client_id" class="form-control selectpicker" style="width: 100%">
                                <option value=""><?= _l('select_client') ?></option>
                                <?php
                                if (!empty($deals_details->customers)) {
                                foreach ($deals_details->customers as $v_customer) {
                                ?>
                                <option value="<?= $v_customer['userid'] ?>" <?php
                                if (!empty($call_info) && $call_info->client_id == $v_customer['userid']) {
                                    echo 'selected';
                                }
                                ?>>
                                    <?= $v_customer['company'] ?>
