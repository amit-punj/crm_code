...
function add_item_to_table(data, itemid, merge_invoice, bill_expense) {
    ...
    get_taxes_dropdown_template(tax_name, data.taxname).done(function (
        ...
        table_row += '<td class="tax_igst"></td>';
        table_row += '<td class="tax_sgst"></td>';
        table_row += '<td class="tax_cgst"></td>';
        table_row += '<td class=""></td>';
            ...
            $.each(item_taxes, function (i, taxname) {
                ...
                if (!taxes.hasOwnProperty(taxname)) {
                    if (taxrate != 0) {
                        ...
                        console.log("taxes[taxname]", taxes[taxname])
                        console.log("taxname", taxname)
                        for_tax.find('td.tax_' + tax_name_price.toLowerCase()).text(taxes[taxname])
                    }
                } else {
