...
*
*/
define('APP_BASE_URL', 'https://crm.taxhint.in/');
...
*/
define('APP_ENC_KEY', '79fbe5771c333cd7295ab0f2cc45bc99');
 ...
 */
// define('APP_DB_USERNAME', 'crm_taxhint_');
define('APP_DB_USERNAME', 'root');
/**
 * The password used to connect to the database
 */
// define('APP_DB_PASSWORD', 'lTS5w4BtNaIVUXae');
define('APP_DB_PASSWORD', '');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'crm_taxhint_');
